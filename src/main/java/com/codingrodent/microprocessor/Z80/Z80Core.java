...
public class Z80Core implements ICPUData {
    ...
    private void extendedIndexCB() {
        ...
        //
        switch (instruction) {
            case 0x00 -> shiftRLCIndexed();
            case 0x01 -> shiftRLCIndexed();
            case 0x02 -> shiftRLCIndexed();
            case 0x03 -> shiftRLCIndexed();
            case 0x04 -> shiftRLCIndexed();
            case 0x05 -> shiftRLCIndexed();
            case 0x06 -> shiftRLCIndexed();
            case 0x07 -> shiftRLCIndexed();
            case 0x08 -> shiftRRCIndexed();
            case 0x09 -> shiftRRCIndexed();
            case 0x0A -> shiftRRCIndexed();
            case 0x0B -> shiftRRCIndexed();
            case 0x0C -> shiftRRCIndexed();
            case 0x0D -> shiftRRCIndexed();
            case 0x0E -> shiftRRCIndexed();
            case 0x0F -> shiftRRCIndexed();
            //
            case 0x10 -> shiftRLIndexed();
            case 0x11 -> shiftRLIndexed();
            case 0x12 -> shiftRLIndexed();
            case 0x13 -> shiftRLIndexed();
            case 0x14 -> shiftRLIndexed();
            case 0x15 -> shiftRLIndexed();
            case 0x16 -> shiftRLIndexed();
            case 0x17 -> shiftRLIndexed();
            case 0x18 -> shiftRRIndexed();
            case 0x19 -> shiftRRIndexed();
            case 0x1A -> shiftRRIndexed();
            case 0x1B -> shiftRRIndexed();
            case 0x1C -> shiftRRIndexed();
            case 0x1D -> shiftRRIndexed();
            case 0x1E -> shiftRRIndexed();
            case 0x1F -> shiftRRIndexed();
            //
            case 0x20 -> shiftSLAIndexed();
            case 0x21 -> shiftSLAIndexed();
            case 0x22 -> shiftSLAIndexed();
            case 0x23 -> shiftSLAIndexed();
            case 0x24 -> shiftSLAIndexed();
            case 0x25 -> shiftSLAIndexed();
            case 0x26 -> shiftSLAIndexed();
            case 0x27 -> shiftSLAIndexed();
            case 0x28 -> shiftSRAIndexed();
            case 0x29 -> shiftSRAIndexed();
            case 0x2A -> shiftSRAIndexed();
            case 0x2B -> shiftSRAIndexed();
            case 0x2C -> shiftSRAIndexed();
            case 0x2D -> shiftSRAIndexed();
            case 0x2E -> shiftSRAIndexed();
            case 0x2F -> shiftSRAIndexed();
            //
            case 0x30 -> shiftSLLIndexed();
            case 0x31 -> shiftSLLIndexed();
            case 0x32 -> shiftSLLIndexed();
            case 0x33 -> shiftSLLIndexed();
            case 0x34 -> shiftSLLIndexed();
            case 0x35 -> shiftSLLIndexed();
            case 0x36 -> shiftSLLIndexed();
            case 0x37 -> shiftSLLIndexed();
            case 0x38 -> shiftSRLIndexed();
            case 0x39 -> shiftSRLIndexed();
            case 0x3A -> shiftSRLIndexed();
            case 0x3B -> shiftSRLIndexed();
            case 0x3C -> shiftSRLIndexed();
            case 0x3D -> shiftSRLIndexed();
            case 0x3E -> shiftSRLIndexed();
            case 0x3F -> shiftSRLIndexed();
            //
            case 0x40 -> testIndexBit(0);
            case 0x41 -> testIndexBit(0);
            case 0x42 -> testIndexBit(0);
            case 0x43 -> testIndexBit(0);
            case 0x44 -> testIndexBit(0);
            case 0x45 -> testIndexBit(0);
            case 0x46 -> testIndexBit(0);
            case 0x47 -> testIndexBit(0);
            case 0x48 -> testIndexBit(1);
            case 0x49 -> testIndexBit(1);
            case 0x4A -> testIndexBit(1);
            case 0x4B -> testIndexBit(1);
            case 0x4C -> testIndexBit(1);
            case 0x4D -> testIndexBit(1);
            case 0x4E -> testIndexBit(1);
            case 0x4F -> testIndexBit(1);
            //
            case 0x50 -> testIndexBit(2);
            case 0x51 -> testIndexBit(2);
            case 0x52 -> testIndexBit(2);
            case 0x53 -> testIndexBit(2);
            case 0x54 -> testIndexBit(2);
            case 0x55 -> testIndexBit(2);
            case 0x56 -> testIndexBit(2);
            case 0x57 -> testIndexBit(2);
            case 0x58 -> testIndexBit(3);
            case 0x59 -> testIndexBit(3);
            case 0x5A -> testIndexBit(3);
            case 0x5B -> testIndexBit(3);
            case 0x5C -> testIndexBit(3);
            case 0x5D -> testIndexBit(3);
            case 0x5E -> testIndexBit(3);
            case 0x5F -> testIndexBit(3);
            //
            case 0x60 -> testIndexBit(4);
            case 0x61 -> testIndexBit(4);
            case 0x62 -> testIndexBit(4);
            case 0x63 -> testIndexBit(4);
            case 0x64 -> testIndexBit(4);
            case 0x65 -> testIndexBit(4);
            case 0x66 -> testIndexBit(4);
            case 0x67 -> testIndexBit(4);
            case 0x68 -> testIndexBit(5);
            case 0x69 -> testIndexBit(5);
            case 0x6A -> testIndexBit(5);
            case 0x6B -> testIndexBit(5);
            case 0x6C -> testIndexBit(5);
            case 0x6D -> testIndexBit(5);
            case 0x6E -> testIndexBit(5);
            case 0x6F -> testIndexBit(5);
            //
            case 0x70 -> testIndexBit(6);
            case 0x71 -> testIndexBit(6);
            case 0x72 -> testIndexBit(6);
            case 0x73 -> testIndexBit(6);
            case 0x74 -> testIndexBit(6);
            case 0x75 -> testIndexBit(6);
            case 0x76 -> testIndexBit(6);
            case 0x77 -> testIndexBit(6);
            case 0x78 -> testIndexBit(7);
            case 0x79 -> testIndexBit(7);
            case 0x7A -> testIndexBit(7);
            case 0x7B -> testIndexBit(7);
            case 0x7C -> testIndexBit(7);
            case 0x7D -> testIndexBit(7);
            case 0x7E -> testIndexBit(7);
            case 0x7F -> testIndexBit(7);
            //
            case 0x80 -> bitIndexReset(0);
            case 0x81 -> bitIndexReset(0);
            case 0x82 -> bitIndexReset(0);
            case 0x83 -> bitIndexReset(0);
            case 0x84 -> bitIndexReset(0);
            case 0x85 -> bitIndexReset(0);
            case 0x86 -> bitIndexReset(0);
            case 0x87 -> bitIndexReset(0);
            case 0x88 -> bitIndexReset(1);
            case 0x89 -> bitIndexReset(1);
            case 0x8A -> bitIndexReset(1);
            case 0x8B -> bitIndexReset(1);
            case 0x8C -> bitIndexReset(1);
            case 0x8D -> bitIndexReset(1);
            case 0x8E -> bitIndexReset(1);
            case 0x8F -> bitIndexReset(1);
            //
            case 0x90 -> bitIndexReset(2);
            case 0x91 -> bitIndexReset(2);
            case 0x92 -> bitIndexReset(2);
            case 0x93 -> bitIndexReset(2);
            case 0x94 -> bitIndexReset(2);
            case 0x95 -> bitIndexReset(2);
            case 0x96 -> bitIndexReset(2);
            case 0x97 -> bitIndexReset(2);
            case 0x98 -> bitIndexReset(3);
            case 0x99 -> bitIndexReset(3);
            case 0x9A -> bitIndexReset(3);
            case 0x9B -> bitIndexReset(3);
            case 0x9C -> bitIndexReset(3);
            case 0x9D -> bitIndexReset(3);
            case 0x9E -> bitIndexReset(3);
            case 0x9F -> bitIndexReset(3);
            //
            case 0xA0 -> bitIndexReset(4);
            case 0xA1 -> bitIndexReset(4);
            case 0xA2 -> bitIndexReset(4);
            case 0xA3 -> bitIndexReset(4);
            case 0xA4 -> bitIndexReset(4);
            case 0xA5 -> bitIndexReset(4);
            case 0xA6 -> bitIndexReset(4);
            case 0xA7 -> bitIndexReset(4);
            case 0xA8 -> bitIndexReset(5);
            case 0xA9 -> bitIndexReset(5);
            case 0xAA -> bitIndexReset(5);
            case 0xAB -> bitIndexReset(5);
            case 0xAC -> bitIndexReset(5);
            case 0xAD -> bitIndexReset(5);
            case 0xAE -> bitIndexReset(5);
            case 0xAF -> bitIndexReset(5);
            //
            case 0xB0 -> bitIndexReset(6);
            case 0xB1 -> bitIndexReset(6);
            case 0xB2 -> bitIndexReset(6);
            case 0xB3 -> bitIndexReset(6);
            case 0xB4 -> bitIndexReset(6);
            case 0xB5 -> bitIndexReset(6);
            case 0xB6 -> bitIndexReset(6);
            case 0xB7 -> bitIndexReset(6);
            case 0xB8 -> bitIndexReset(7);
            case 0xB9 -> bitIndexReset(7);
            case 0xBA -> bitIndexReset(7);
            case 0xBB -> bitIndexReset(7);
            case 0xBC -> bitIndexReset(7);
            case 0xBD -> bitIndexReset(7);
            case 0xBE -> bitIndexReset(7);
            case 0xBF -> bitIndexReset(7);
            //
            case 0xC0 -> bitIndexSet(0);
            case 0xC1 -> bitIndexSet(0);
            case 0xC2 -> bitIndexSet(0);
            case 0xC3 -> bitIndexSet(0);
            case 0xC4 -> bitIndexSet(0);
            case 0xC5 -> bitIndexSet(0);
            case 0xC6 -> bitIndexSet(0);
            case 0xC7 -> bitIndexSet(0);
            case 0xC8 -> bitIndexSet(1);
            case 0xC9 -> bitIndexSet(1);
            case 0xCA -> bitIndexSet(1);
            case 0xCB -> bitIndexSet(1);
            case 0xCC -> bitIndexSet(1);
            case 0xCD -> bitIndexSet(1);
            case 0xCE -> bitIndexSet(1);
            case 0xCF -> bitIndexSet(1);
            //
            case 0xD0 -> bitIndexSet(2);
            case 0xD1 -> bitIndexSet(2);
            case 0xD2 -> bitIndexSet(2);
            case 0xD3 -> bitIndexSet(2);
            case 0xD4 -> bitIndexSet(2);
            case 0xD5 -> bitIndexSet(2);
            case 0xD6 -> bitIndexSet(2);
            case 0xD7 -> bitIndexSet(2);
            case 0xD8 -> bitIndexSet(3);
            case 0xD9 -> bitIndexSet(3);
            case 0xDA -> bitIndexSet(3);
            case 0xDB -> bitIndexSet(3);
            case 0xDC -> bitIndexSet(3);
            case 0xDD -> bitIndexSet(3);
            case 0xDE -> bitIndexSet(3);
            case 0xDF -> bitIndexSet(3);
            //
            case 0xE0 -> bitIndexSet(4);
            case 0xE1 -> bitIndexSet(4);
            case 0xE2 -> bitIndexSet(4);
            case 0xE3 -> bitIndexSet(4);
            case 0xE4 -> bitIndexSet(4);
            case 0xE5 -> bitIndexSet(4);
            case 0xE6 -> bitIndexSet(4);
            case 0xE7 -> bitIndexSet(4);
            case 0xE8 -> bitIndexSet(5);
            case 0xE9 -> bitIndexSet(5);
            case 0xEA -> bitIndexSet(5);
            case 0xEB -> bitIndexSet(5);
            case 0xEC -> bitIndexSet(5);
            case 0xED -> bitIndexSet(5);
            case 0xEE -> bitIndexSet(5);
            case 0xEF -> bitIndexSet(5);
            //
            case 0xF0 -> bitIndexSet(6);
            case 0xF1 -> bitIndexSet(6);
            case 0xF2 -> bitIndexSet(6);
            case 0xF3 -> bitIndexSet(6);
            case 0xF4 -> bitIndexSet(6);
            case 0xF5 -> bitIndexSet(6);
            case 0xF6 -> bitIndexSet(6);
            case 0xF7 -> bitIndexSet(6);
            case 0xF8 -> bitIndexSet(7);
            case 0xF9 -> bitIndexSet(7);
            case 0xFA -> bitIndexSet(7);
            case 0xFB -> bitIndexSet(7);
            case 0xFC -> bitIndexSet(7);
            case 0xFD -> bitIndexSet(7);
            case 0xFE -> bitIndexSet(7);
            case 0xFF -> bitIndexSet(7);
        }
        incPC();
    }
