 ...
 */
public class Z80Core implements ICPU, ICPUData {
    ...
    private void decodeOneByteInstruction(int opcode) {
        ...
        switch (opcode) {
            ...
            case 0x01 -> ioQueue.readWord(reg_PC, word -> {
                setBC(word);
                inc2PC();
            }); // LD bc, nnnn
            ...
            case 0x06 -> ioQueue.readByte(reg_PC, b -> {
                reg_B = b;
                incPC();
            }); // ld b,nn
            case 0x07 -> RLCA(); // rlca
            ...
            case 0x0A -> ioQueue.readByte(getBC(), b -> reg_A = b); // LD a, (bc)
            case 0x0B -> setBC(ALU16BitDec(getBC())); // dec bc
            case 0x0C -> reg_C = ALU8BitInc(reg_C); // inc c
            case 0x0D -> reg_C = ALU8BitDec(reg_C); // dec c
            case 0x0E -> ioQueue.readByte(reg_PC, b -> {
                reg_C = b;
                incPC();
            }); // ld c,n
            case 0x0F -> RRCA(); // rrca
            case 0x10 -> djnz(); // djnz
            case 0x11 -> ioQueue.readWord(reg_PC, word -> {
                setDE(word);
                inc2PC();
            }); // LD de, nnnn
            ...
            case 0x16 -> ioQueue.readByte(reg_PC, b -> {
                reg_D = b;
                incPC();
            }); // ld d,nn
            case 0x17 -> RLA(); // rla
            ...
            case 0x21 -> ioQueue.readWord(reg_PC, word -> {
                setHL(word);
                inc2PC();
            }); // LD hl, nnnn
            case 0x22 -> ioQueue.readWord(reg_PC, word -> {
            ...
            case 0x26 -> ioQueue.readByte(reg_PC, b -> {
                reg_H = b;
                incPC();
            }); // ld h,nn
            case 0x27 -> DAA(); // daa
            ...
            case 0x2A -> ioQueue.readWord(reg_PC, fromPc -> ioQueue.readWord(fromPc, fromMem -> {
                setHL(fromMem);
                inc2PC();
            })); // LD hl, (nnnn)
            ...
            case 0x2E -> ioQueue.readByte(reg_PC, b -> {
                reg_L = b;
                incPC();
            }); // ld l,n
            case 0x2F -> CPL(); // rra
            ...
            case 0x31 -> ioQueue.readWord(reg_PC, word -> {
                reg_SP = word;
                inc2PC();
            }); // LD sp, nnnn
            case 0x32 -> ioQueue.readWord(reg_PC, word -> {
                ioQueue.writeByte(word, reg_A);
                inc2PC();
            }); // LD (nnnn), A
            case 0x33 -> reg_SP = ALU16BitInc(reg_SP); // inc SP
            case 0x34 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), ALU8BitInc(b))); // inc (hl)
            case 0x35 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), ALU8BitDec(b))); // dec (hl)
            case 0x36 -> ioQueue.readByte(reg_PC, b -> {
            ...
            case 0x46 -> ioQueue.readByte(getHL(), b -> reg_B = b); // ld b,(hl)
            ...
            case 0x4E -> ioQueue.readByte(getHL(), b -> reg_C = b); // ld c,(hl)
            ...
            case 0x56 -> ioQueue.readByte(getHL(), b -> reg_D = b); // ld d,(hl)
            ...
            case 0x5E -> ioQueue.readByte(getHL(), b -> reg_E = b); // ld e,(hl)
            ...
            case 0x66 -> ioQueue.readByte(getHL(), b -> reg_H = b); // ld h,(hl)
            ...
            case 0x6E -> ioQueue.readByte(getHL(), b -> reg_L = b); // ld l,(hl)
            ...
            case 0x7E -> ioQueue.readByte(getHL(), b -> reg_A = b); // ld a,(hl)
            case 0x7F -> {
            }  /* reg_A = reg_A; */ // ld a,a
            // add
            ...
            case 0x86 -> ioQueue.readByte(getHL(), this::ALU8BitAdd);
            ...
            case 0x8E -> ioQueue.readByte(getHL(), this::ALU8BitAdc);
            ...
            case 0x96 -> ioQueue.readByte(getHL(), this::ALU8BitSub);
            ...
            case 0x9E -> ioQueue.readByte(getHL(), this::ALU8BitSbc);
            ...
            case 0xA6 -> ioQueue.readByte(getHL(), this::ALU8BitAnd);
            ...
            case 0xAE -> ioQueue.readByte(getHL(), this::ALU8BitXor);
            ...
            case 0xB6 -> ioQueue.readByte(getHL(), this::ALU8BitOr);
            ...
            case 0xBE -> ioQueue.readByte(getHL(), this::ALU8BitCp);
            case 0xBF -> ALU8BitCp(reg_A);
            //
            case 0xC0 -> ret(!getZ());
            case 0xC1 -> ioQueue.readWord(reg_SP, word -> {
                setBC(word);
                inc2SP();
            });
            case 0xC2 -> jp(!getZ());
            ...
            case 0xC6 -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitAdd(b);
                incPC();
            });
            case 0xc7 -> rst(0);
            ...
            case 0xCC -> call(getZ());
            case 0xCD -> call();
            case 0xCE -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitAdc(b);
                incPC();
            });
            case 0xCF -> rst(1);
            //
            case 0xD0 -> ret(!getC());
            case 0xD1 -> ioQueue.readWord(reg_SP, word -> {
                setDE(word);
                inc2SP();
            });
            case 0xD2 -> jp(!getC());
            ...
            case 0xD6 -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitSub(b);
                incPC();
            });
            case 0xD7 -> rst(2);
            ...
            case 0xDE -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitSbc(b);
                incPC();
            });
            case 0xDF -> rst(3);
            //
            case 0xE0 -> ret(!getPV());
            case 0xE1 -> ioQueue.readWord(reg_SP, word -> {
                setHL(word);
                inc2SP();
            });
            case 0xE2 -> jp(!getPV());
            ...
            case 0xE6 -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitAnd(b);
                incPC();
            });
            case 0xE7 -> rst(4);
            ...
            case 0xEE -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitXor(b);
                incPC();
            });
            case 0xEF -> rst(5);
            ...
            case 0xF6 -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitOr(b);
                incPC();
            });
            case 0xF7 -> rst(6);
            ...
            case 0xFE -> ioQueue.readByte(reg_PC, b -> {
                ALU8BitCp(b);
                incPC();
            });
            case 0xFF -> rst(7);
    ...
    private void extendedCB() {
        ioQueue.readByte(reg_PC, instructionByte -> {
            ...
            switch (instruction) {
                ...
                case 0x06 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericRLC(b)));
                ...
                case 0x0E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericRRC(b)));
                ...
                case 0x16 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericRL(b)));
                ...
                case 0x1E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericRR(b)));
                ...
                case 0x26 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericSLA(b)));
                ...
                case 0x2E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericSRA(b)));
                ...
                case 0x36 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericSLL(b)));
                ...
                case 0x3E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), shiftGenericSRL(b)));
                ...
                case 0x86 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit0));
                ...
                case 0x8E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit1));
                ...
                case 0x96 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit2));
                ...
                case 0x9E -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit3));
                ...
                case 0xA6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit4));
                ...
                case 0xAE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit5));
                ...
                case 0xB6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit6));
                ...
                case 0xBE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b & resetBit7));
                ...
                case 0xC6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit0));
                ...
                case 0xCE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit1));
                ...
                case 0xD6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit2));
                ...
                case 0xDE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit3));
                ...
                case 0xE6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit4));
                ...
                case 0xEE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit5));
                ...
                case 0xF6 -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit6));
                ...
                case 0xFE -> ioQueue.readByte(getHL(), b -> ioQueue.writeByte(getHL(), b | setBit7));
    ...
    private void extendedED() {
        ioQueue.readByte(reg_PC, instructionByte -> {
            ...
            switch (instruction) {
                ...
                case 0xA0 -> ioQueue.readByte(getHL(), this::LDI);
                case 0xA1 -> ioQueue.readByte(getHL(), this::CPI);
                case 0xA2 -> ioQueue.ioRead(getBC(), this::INI);
                case 0xA3 -> ioQueue.readByte(getHL(), this::OUTI);
                case 0xA4, 0xA5, 0xA6, 0xA7 -> {
                } // NOP
                case 0xA8 -> ioQueue.readByte(getHL(), this::LDD);
                case 0xA9 -> ioQueue.readByte(getHL(), this::CPD);
                case 0xAA -> ioQueue.ioRead(getBC(), this::IND);
                case 0xAB -> ioQueue.readByte(getHL(), this::OUTD);
    ...
    private void extendedDDFD() {
        ioQueue.readByte(reg_PC, instructionByte -> {
            ...
            switch (instruction) {
                ...
                case 0x22 -> ioQueue.readWord(reg_PC, word -> {
                    ioQueue.writeWord(word, reg_index);
                    inc2PC();
                });
                ...
                case 0x2E -> ioQueue.readByte(reg_PC, temp -> {
                    setIndexReg((reg_index & 0xFF00) | temp);
                    incPC();
                }); // ld IXl, nn
                case 0x2F -> CPL(); // rra
                ...
                case 0x3A -> ioQueue.readWord(reg_PC, fromPc -> ioQueue.readByte(fromPc, fromMem -> {
                    reg_A = fromMem;
                    inc2PC();
                })); // LD a, (nnnn)
                case 0x3B -> reg_SP = ALU16BitDec(reg_SP); // dec sp
                ...
                case 0x64 ->
                        getIndexAddressUndocumented(regCodeIXH, b -> setIndexAddressUndocumented(b, regCodeIXH)); // ld ixh, IXh
                case 0x65 -> getIndexAddressUndocumented(regCodeIXL, b -> setIndexAddressUndocumented(b, regCodeIXH));
                ...
                case 0x6C ->
                        getIndexAddressUndocumented(regCodeIXH, b -> setIndexAddressUndocumented(b, regCodeIXL)); // ld ixl, IXh
                case 0x6D ->
                        getIndexAddressUndocumented(regCodeIXL, b -> setIndexAddressUndocumented(b, regCodeIXL)); // ld ixl, IXl
                ...
                case 0x74 ->
                        get8BitRegisterIndexed(regCodeH, b -> setIndexAddressUndocumented(b, regCodeM)); // ld (ix+d), IXh
                case 0x75 ->
                        get8BitRegisterIndexed(regCodeL, b -> setIndexAddressUndocumented(b, regCodeM)); // ld (ix+d), IXl
                case 0x76 -> {
                    decPC(); // execute it forever !
                    halt = true;
                }
                case 0x77 ->
                        get8BitRegisterIndexed(regCodeA, b -> setIndexAddressUndocumented(b, regCodeM)); // ld (ix+d), a
                case 0x78 -> reg_A = reg_B; // ld a, b
                case 0x79 -> reg_A = reg_C; // ld a, c
                case 0x7A -> reg_A = reg_D; // ld a, d
                case 0x7B -> reg_A = reg_E; // ld a, e
    ...
    private void extendedIndexCB() {
        ioQueue.readByte(reg_PC + 1/* fudge for DD CB dd ii */, instructionByte -> {
            instruction = instructionByte;
    ...
    private void shiftRLCIndexed(int reg) {
        getIndexAddress(address -> ioQueue.readByte(address, b -> {
            int regValue = shiftGenericRLC(b);
            ioQueue.writeByte(address, regValue);
            //
            if (reg != 6) { // (rr)
    ...
    private void relativeJump() {
        reg_R++;
        ioQueue.readByte(reg_PC, offset -> {
            if (offset > 0x007F) {
    ...
    private void jp(boolean cc) {
        tStates = tStates + 10;
        if (cc) {
            ioQueue.readWord(reg_PC, word -> reg_PC = word);
        } else {
            inc2PC();
        }
    }
    ...
    private void call() {
        tStates = tStates + 17;
        ioQueue.readWord(reg_PC, destination -> {
            inc2PC();
            dec2SP();
            ioQueue.writeWord(reg_SP, reg_PC);
            reg_PC = destination;
    ...
    /* IN A,(NN) */
    private void inAN() {
        getInOutAddressRegA(address -> ioQueue.ioRead(address, b -> {
            reg_A = b;
            incPC();
            reg_R++;
        }));
    ...
    private void getInOutAddressRegA(Consumer<Integer> consumer) {
        ...
        ioQueue.readByte(reg_PC, b -> consumer.accept((reg_A << 8) + b));
    }

    /* IN rr,(c) */
    private void inC(int reg) {
        ioQueue.ioRead(getBC(), temp -> {
    ...
    private void testBitInMemory(int bit) {
        ioQueue.readByte(getHL(), b -> testBitGeneric(bit, b));
    }
    ...
    private void LDIR() {
        tStates = tStates + 21;
        ioQueue.readByte(getHL(), b -> {
            LDI(b);
            if (getBC() != 0) {
                //FixMe Stack overflow on sync IO?
                LDIR();
            }
        });
    }
    ...
    private void LDRegnnnnInd16Bit(int regCode) {
        ioQueue.readWord(reg_PC, address -> ioQueue.readWord(address, data -> {
    ...
    private void LDnnnnRegInd16Bit(int regCode) {
        ioQueue.readWord(reg_PC, address -> {
            ioQueue.writeWord(address, get16BitRegister(regCode));
            inc2PC();
        });
    }
    //
    ...
    private void getIndexAddressUndocumented(int reg, Callback consumer) {
        ...
        switch (reg) {
            ...
            default -> {
                reg_R++;
                getIndexOffset(offset -> ioQueue.readByte((reg_index + offset) & lsw, consumer));
            } // (index+dd)
        }
    }
    ...
    private void setIndexAddressUndocumented(int value, int reg) {
        ...
        switch (reg) {
            ...
            default -> getIndexAddress(address -> ioQueue.writeByte(address, value)); // (index+dd)
        }
    }
    ...
    private void get8BitRegisterIndexed(int reg, Callback consumer) {
        switch (reg) {
            ...
            default -> {
                reg_R++;
                getIndexAddress(address -> ioQueue.readByte(address, consumer));
            } // (index+dd)
        }
    }
    ...
    private void incIndex() {
        getIndexAddress(address -> ioQueue.readByte(address, b -> {
            ...
            reg_R++;
            ioQueue.writeByte(address, data);
        }));
    }
    ...
    private void testIndexBit(int bit) {
        reg_R++;
        getIndexAddress(address -> ioQueue.readByte(address, temp ->
    ...
    private void bitIndexSet(int bit, int reg) {
        reg_R++;
        getIndexAddress(address -> ioQueue.readByte(address, v -> {
            v = switch (bit) {
                case 0 -> v | setBit0;
                case 1 -> v | setBit1;
                case 2 -> v | setBit2;
    ...
    private void loadIndex8BitImmediate() {
        reg_R++;
        getIndexAddress(address -> ioQueue.readByte(reg_PC, data -> {
            incPC();
            ioQueue.writeByte(address, data);
        }));
    }
